        ...
        <div class="col-md-6 center">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> Selecteer welke meting waarden u wilt wijzigen</h3>
                </div>
                <form action="edit.php" method="post">
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <tr>
                            <td> Selecteer de verfsoort</td>
                            <td>
                                <select name="selecteer_verf">
                        ...
                        <tr>
                            <td> Selecteer de kleur</td>
                            <td>

                                <select id="kleur" name="selecteer_kleur">
                        ...
                        <tr>
                            ...
                            <td><input class="submit" type="submit" name="submitKiezen" value="Ga door"></td>
                        </tr>
                        </tbody>
                </form>
                </table>
