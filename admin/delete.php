        ...
        <div class="container main">
            <div class="col-md-6 center">
                <div class="panel panel-primary">
                    <div class="panel-heading"><h3 class="panel-title">Succesvol admin verwijderd</h3></div>
                    <table class="table table-hover" id="dev-table"><br>
    <?php

        $query = "DELETE FROM gebruikers WHERE id = ". $verwijder_id ;
...
<footer class="site-footer" role="contentinfo">
    ...
    <script>
        $(".container.main").css("min-height",window.innerHeight-371);
    </script>
</footer>
