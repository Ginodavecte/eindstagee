...
<body>
    ...
    $verwijder_verf = $_GET['verf'];

    //var_dump($verwijder_kleur_id,$verwijder_verf);
    if (is_int($verwijder_kleur_id) && is_string($verwijder_verf)) {
        ...
        <div class="col-md-6 center">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Succesvol kleur verwijderd </h3>
                </div>
                <table class="table table-hover" id="dev-table">
                    <?php

        $query = "DELETE FROM $verwijder_verf WHERE id = ". $verwijder_kleur_id ;
        $result = mysqli_query($connection, $query);?><br><?php
        echo "    De kleur is succesvol verwijderd van de ".$verwijder_verf."";
    }
    ?>
      <br>      <br>
