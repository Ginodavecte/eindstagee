...
<body>
    <?php
    $sql = mysqli_query($connection,"SELECT * FROM kleuren ");
    $total = mysqli_num_rows($sql);

    $adjacents = 3;
    $targetpage = "pre-deleteColorName.php"; //your file name
    ...
    $sql2 = "SELECT * FROM kleuren WHERE 1=1 ORDER BY kleur_id DESC LIMIT $start ,$limit ";
        ...
        <div class="col-md-6">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Verwijder kleur uit database</h3>
                    <h6 style="color: white">* Pas op als u een kleur verwijderd worden alle bijbehorende metingen ook automatisch verwijderd</h6>
                </div>
            <table class="table table-hover">
                ...
                foreach ($subjects as $subject) {
                    ...
                    <tr>
                        <td><?php echo $i;?> </td>
                        <td><?php echo $subject['kleur_naam'];
                            ?>
                        </td>
                        <td><a href="deleteColorName.php?id=<?php echo $subject['kleur_id'];?>">Delete</a> </td>
                    </tr>
